      ...
      <div className='grid grid-cols-2 w-full'>
        <div>
          <Form.Item label="Tên Vị Trí" style={{ fontSize: "1.2rem" }} >
            <Input disabled name="tenViTri" className='rounded-md p-1' style={{ height: "30px" }} onChange={formik.handleChange} value={formik.values.tenViTri} />
          </Form.Item>
          <Form.Item label="Hình Ảnh" style={{ fontSize: "1.2rem" }}>
            <input disabled type="image" src={formik.values.hinhAnh} onChange={formik.handleChange} alt={formik.values.tenViTri } name="hinhAnh" className='rounded-md mt-2 p-1 w-full hover:border-blue-700 cursor-no-drop' style={{ height: "160px", border: "0.5px solid #dadada" }} />
          </Form.Item>
          <Form.Item onClick={() => {
            navigate(-1)
          }}>
        ...
        <div>
          <Form.Item label="Tỉnh Thành" style={{ fontSize: "1.2rem" }} >
            <Input disabled name="tinhThanh" className='rounded-md p-1' style={{ height: "30px" }} onChange={formik.handleChange} value={formik.values.tinhThanh} />
          </Form.Item>
          <Form.Item label="Quốc Gia" style={{ fontSize: "1.2rem" }} >
            <Input disabled name="quocGia" className='rounded-md p-1' style={{ height: "30px" }} onChange={formik.handleChange} value={formik.values.quocGia} />
          </Form.Item>
