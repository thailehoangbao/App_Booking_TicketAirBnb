...
import HeaderMiddleTop from '../HeaderMiddleTop/HeaderMiddleTop';

export default function HeaderTop() {
    const [isMiddle, setIsMiddle] = useState(false);
    const [clickButton, setClickButton] = useState(false);
    const handleMiddleTop = () => {
        ...
        <div className='grid grid-cols-12 p-5'>
            ...
            <div style={{ flex: "1 1 45%" }} className='col-span-6 button-middle-header-top flex flex-wrap justify-center items-center relative z-20' onClick={handleMiddleTop}>
                ...
                <div className='absolute flex flex-wrap px-3 py-1.5 rounded-full shadow-lg border bg-white justify-center items-center cursor-pointer z-20'>
                    ...
                    <div className="inline-flex w-8 h-8 justify-center items-center bg-rose-500 rounded-full text-white"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', fill: 'none', height: 12, width: 12, stroke: 'currentcolor', strokeWidth: '5.33333', overflow: 'visible' }}><g fill="none"><path d="m13 24c6.0751322 0 11-4.9248678 11-11 0-6.07513225-4.9248678-11-11-11-6.07513225 0-11 4.92486775-11 11 0 6.0751322 4.92486775 11 11 11zm8-3 9 9" /></g></svg>
                    </div>
                </div>
            </div>
            <div className="col-span-3 hidden sm:block flex-initial z-20" style={{ flex: '1 1 25%' }}>
                <div className="relative flex items-center justify-end">
                    ...
                    <div className="block z-10">
                        <div className="relative inline">
                            <button type="button" className="relative inline-flex items-center rounded-full border px-2 hover:shadow-lg" onClick={handleClick}>
                                <div className="pl-1">
                            ...
                            { clickButton ? 
                            <div className="absolute z-10 popup-signin bg-slate-200 rounded-md overflow-hidden" style={{ width: "200px", top: "180%", right: 0}}>
                                <div className="font-medium flex flex-col border-b-2">
                                    <NavLink className="hover:bg-gray-100 pl-5 py-2 transition-all duration-400 text-sm " to="/register">Đăng ký</NavLink>
                                    <NavLink className="hover:bg-gray-100 pl-5 py-2 transition-all duration-400 text-sm " to="/login">Đăng nhập</NavLink>
                                </div>
                                <div className="font-normal flex flex-col"><a aria-current="page" className="hover:bg-gray-100 pl-5 py-2  text-sm transition-all duration-400 active" href="/">Cho thuê nhà</a>
                                    <NavLink aria-current="page" className="hover:bg-gray-100 pl-5 py-2  text-sm transition-all duration-400 active" to="/user">Thông Tin Cá Nhân</NavLink>
                                    <NavLink aria-current="page" className="hover:bg-gray-100 pl-5 py-2  text-sm transition-all duration-400 active" to="/">Trở về trang chủ!</NavLink>
                                </div>
                            </div> :
                            ''
                            }
